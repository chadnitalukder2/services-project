<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('roles.index') }}" class="bg-gray-800 hover:bg-gray-700 text-sm rounded-md px-3 py-2 text-white flex justify-center items-center gap-1">
                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('roles.update', $role->id) }}">
                        ...
                        <div>
                            ...
                            <button class="bg-gray-800 hover:bg-gray-700 hover:bg-slate-600 text-sm rounded-md px-3 py-2 text-white">
                                Update
                            </button>
                        </div>
                    </form>
