<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('expense_categories.index') }}" class="bg-gray-800 hover:bg-gray-700 text-sm rounded-md px-3 py-2 text-white flex justify-center items-center gap-1">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('expense_categories.update', $category->id) }}">
                        @csrf
                        <!-- Name -->
                        <div> 
                            ...
                            <div class="my-3">
                                <input placeholder="Enter Name" id="name"
                                    ...
                                    name="name" value="{{ old('name', $category->name) }}" autofocus />
