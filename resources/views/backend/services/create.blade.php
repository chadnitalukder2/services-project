<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('services.index') }}" class="bg-gray-800 hover:bg-gray-700 text-sm rounded-md px-3 py-2 text-white flex justify-center items-center gap-1">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input placeholder="Enter Price" id="unit_price"
                                    class="block mt-1 w-1/2 border-gray-300 rounded-md shadow-sm" type="text"
                                    name="unit_price" :value="old('unit_price')" autofocus />
