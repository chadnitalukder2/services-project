                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input placeholder="Enter Amount" id="amount"
                                    ...
                                    name="amount" value="{{ old('amount', $expense->amount) }}" autofocus />
                            ...
                            <div class="my-3">
                                <textarea rows="4" placeholder="Enter Description" id="description"
                                    class="block mt-1 w-1/2 border-gray-300 rounded-md shadow-sm" name="description">{{ old('description', $expense->description) }}</textarea>
