                    ...
                    <form id="order-form" method="POST" action="{{ route('orders.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-3 flex flex-wrap gap-3 items-start">
                                ...
                                <button type="button" x-data=""
                                    ...
                                    class="bg-gray-800 hover:bg-gray-700 text-sm rounded-md px-4 py-2.5 text-white whitespace-nowrap flex items-center gap-1 flex-shrink-0">
                        ...
                        <div class="text-center justify-center flex md:justify-end md:pt-[18px]">
                            <button type="submit" id="submit-order-btn"
                                class="bg-gray-800 hover:bg-gray-700 text-sm md:text-base font-medium rounded-md px-8 sm:px-10 md:px-11 py-2 text-white flex items-center justify-center gap-2 mx-auto md:mx-0">
