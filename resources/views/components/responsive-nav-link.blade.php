...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2  border-gray-600 text-start text-base font-medium text-black-700 bg-gray-100 rounded-sm focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition duration-150 ease-in-out'
